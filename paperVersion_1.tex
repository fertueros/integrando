...
\usepackage[utf8]{inputenc} % esto es para español
\usepackage{longtable} % esto es para tabla
...
% Date and time: mié., Jul. 25, 2018 - 18:59:16
...
% Table created by stargazer v.5.2.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: mié., Jul. 25, 2018 - 18:59:17
\begin{table}[!htbp] \centering 
