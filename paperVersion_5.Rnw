...
% PLOTS mapas
% eval=FALSE
% results=HIDE (verbatim default) %para quitar los comentarios cuando se cargan los paquetes
%%%%
...
<<checkNames, echo=FALSE,eval=FALSE>>=
names(mapaMundo)
@
...
plot(mapaMundo,col='black')
plot(mapaMundoAll,col='pink',border='grey',add=T)
@
\end{adjustbox}
