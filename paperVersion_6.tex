...
\usepackage{natbib} %para mejorar las bibliografias

\usepackage[spanish]{babel} %para mejorar el español
\renewcommand\spanishtablename{Tabla} %renombrando para q no salga cuadro
...
% Date and time: mié., Jul. 25, 2018 - 20:16:12
...
Así, propongo que calculemos conglomerados de países usando toda la información de tres de los indicadores. Como nuestras variables son ordinales utilizaremos un proceso de conglomeración donde las distancia serán calculadas usando la medida {\bf gower}
% propuesta por 
\cite{gower_general_1971} %primero usar zotero
, y para los enlazamientos usaremos la técnica de {\bf medoides} 
 siguiendo a \cite{reynolds_clustering_2006} %este tambien es de zotero
...
\bibliography{Repro} %el archivo de zotero
